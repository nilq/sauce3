...
-------------------------------------------------------------------------------
-- The primary responsibility for the sauce3.graphics module is the drawing of
...
-- Sauce3's coordinate system is rooted in the upper-left corner of the screen,
...
check = (textureBased) ->
  if textureBased
    ...
    if shapes\isDrawing! then Sauce3VM.util\endShapes shapes
    ...
    if batch\isDrawing! then Sauce3VM.util\endBatch batch
...
-- sauce3.draw = ->
--   sauce3.graphics.arc( "fill", 400, 300, 100, 0, math.pi )
--  
-- -- Drawing Pacman
-- pacwidth = math.pi / 6 -- size of his mouth
-- sauce3.draw = ->
--   sauce3.graphics.setColor( 255, 255, 0 ) -- pacman needs to be yellow
--   sauce3.graphics.arc( "fill", 400, 300, 100, pacwidth, (math.pi * 2) - pacwidth )
