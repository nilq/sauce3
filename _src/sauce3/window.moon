...
-- program's window.
-------------------------------------------------------------------------------
-- @module sauce3.window

import project, java from sauce3
...
-- density-independent units.
-- @usage
-- x, y = sauce3.window.fromPixels px, py
fromPixels = (px, py) ->
  scale = getPixelScale!
...
-- @usage
-- modes = sauce3.window.getDisplayModes!
getDisplayModes = ->
...
-- @usage
-- width, height, fullscreen = sauce3.window.getMode!
getMode = ->
...
-- @usage
-- height = sauce3.window.getHeight!
getHeight = ->
...
-- @usage
-- scale = sauce3.window.getPixelScale!
getPixelScale = ->
...
-- @usage
-- fullscreen = sauce3.window.isFullscreen!
isFullscreen = ->
...
-- @usage
-- sauce3.window.setFullscreen fullscreen
...
-- @usage
-- sauce3.window.setMode width, height, fullscreen
...
-- @usage
-- px, py = sauce3.window.toPixels x, y
toPixels = (x, y) ->
  scale = getPixelScale!
